...
var layout = [{
		...
		render: function(row) {
			...
			var num2 =Math.floor(Math.random()*(30-1+1) + 1)
			
			return '<a>2017-'+num+'-'+num2+'</a>';
		}
	},
	{
		name: '金额',
		...
		style: 'width: 20%',
		render: function(row) {
			var num2 =Math.floor(Math.random()*(2000-1+1) + 100)
			return '<a>'+num2+'</a>';
		}
	},
	{
	...
	},
	{
		...
		style: 'width: 10%',
		render: function(row) {
			return '<span class="layui-btn layui-btn-normal layui-btn-xs">成功交易</span>';
		}
	},
	{
		name: '操作',
